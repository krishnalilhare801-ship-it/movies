...
BOT_TOKEN = environ.get('BOT_TOKEN', '8705195815:AAHudyu44UcMBqSPNiSJMqpeJw1DalWxzv8')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6934918664').split()]
USERNAME = environ.get('USERNAME', "https://t.me/Filmy_Movie1_Bot") # ADMIN USERNAME
