...
BOT_TOKEN = environ.get('BOT_TOKEN', '8781004762:AAH0NHZaosPsvDHFl7P1_Qdo8mzAxRbMTaE')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6934918664').split()]
USERNAME = environ.get('USERNAME', "t.me/MN_movie_bot") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002118498742'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', '@newallmoviesearchgroup')
